...
From these results, it seems that yet again the on-the-fly ray tracing by $z$-stack performs slightly better than on-the-fly ray tracing by individual 3D track. It is important to note the slowdown in integration time from Falcon to Cetus, highlighting the extent to which the cores on Cetus are slower than the cores on Falcon. 
...
%Results are shown for both flat and linear sources.

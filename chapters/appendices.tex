...
\vspace{2mm}
\caption[U-238 capture rate absolute errors for the 2D quarter core \ac{BEAVRS} model]{U-238 capture rate absolute errors for the 2D quarter core \ac{BEAVRS} model corresponding to the reference in Fig.~\ref{fig:chap7-capt-rates-full-core}.}

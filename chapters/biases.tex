...
\begin{highlightsbox}[frametitle=Highlights]
      \begin{itemize}
      \item At least 4 million neutrons should be simulated per \ac{FSG} to
      avoid under-sampling in $2$-D BEAVRS model. This was determined from Shannon entropy
      convergence studies. 
      \item At least 4 million neutrons should be simulated per \ac{FSG} to
      avoid under-sampling in $3$-D BEAVRS model.
      \item Fission source convergence requires more \acp{FSG} for $3$-D BEAVRS
      compared with $2$-D BEAVRS.
      \end{itemize}
\end{highlightsbox}
\vfill
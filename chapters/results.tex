...
\end{subfigure}
\caption[U-238 capture rate errors for \ac{BEAVRS}]{U-238 capture percent relative errors for the quarter core \ac{BEAVRS} model with \textit{i}\ac{MGXS} spatial homogenization with BIRCH clustering of 4 (a) and 20 (b) clusters.}
...
\caption[Capture-to-fission rate errors for \ac{BEAVRS}]{Percent relative errors on the U-238 capture to total fission rate ratio for the quarter core \ac{BEAVRS} model with null spatial homogenization.}
...
\end{subfigure}
\caption[Capture-to-fission rate errors for \ac{BEAVRS}]{Percent relative errors on the U-238 capture to total fission rate ratio for the quarter core \ac{BEAVRS} model with \ac{LNS} (a) and degenerate (b) spatial homogenization.}
...
\end{subfigure}
\caption[Capture-to-fission rate errors for \ac{BEAVRS}]{Percent relative errors on the U-238 capture to total fission rate ratio for the quarter core \ac{BEAVRS} model with \textit{i}\ac{MGXS} spatial homogenization with BIRCH clustering of 4 (a) and 20 (b) clusters.}

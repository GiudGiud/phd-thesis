...
\begin{figure}[h!]
\centering
\includegraphics[width=0.75\linewidth]{figures/unsupervised/flow-chart}
\vspace{2mm}
...
\begin{figure}[h!]
\centering
\includegraphics[width=0.95\linewidth]{figures/unsupervised/pipeline}
\vspace{2mm}
...
Each of the features described in the preceding sections is assembled into feature vectors for each sample as illustrated in Fig.~\ref{fig:chap10-feature-ex}. From a more practical standpoint, the \textit{i}\ac{MGXS} implementation in this thesis represents the sample feature vectors with a 2D \texttt{DataFrame} object from the Pandas module~\cite{mckinney2010pandas} for data processing in Python. Each column in the \texttt{DataFrame} corresponds to a feature, and each row corresponds to a sample. This \texttt{DataFrame} is the input to the feature selection and/or transformation stages of the \textit{i}\ac{MGXS} pipeline as discussed in the following sections. 

\begin{figure}[h!]
\centering
\includegraphics[width=0.95\linewidth]{figures/unsupervised/features/engineering/features}
\vspace{2mm}
\caption[Example \textit{i}MGXS sample feature vectors]{Feature extraction creates features from \ac{MC} tally data. Each case study presented in this thesis extracts features from 2-group \ac{MGXS} as illustrated here.}
\label{fig:chap10-features}
\end{figure}
...
%
%\begin{equation}
%g_{1}\left(\hat{\boldsymbol{f}}_{1}\right)
%\end{equation}
%
%\begin{equation}
%g_{2}\left(\hat{\boldsymbol{f}}_{1}\right)
%\end{equation}
%
%\begin{equation}
%g_{T}\left(\hat{\boldsymbol{f}}_{1}\right)
%\end{equation}
%
%
%\begin{equation}
%g_{1}\left(\hat{\boldsymbol{f}}_{2}\right)
%\end{equation}
%
%\begin{equation}
%g_{2}\left(\hat{\boldsymbol{f}}_{2}\right)
%\end{equation}
%
%\begin{equation}
%g_{T}\left(\hat{\boldsymbol{f}}_{2}\right)
%\end{equation}
%
%
%\begin{equation}
%g_{1}\left(\hat{\boldsymbol{f}}_{K}\right)
%\end{equation}
%
%\begin{equation}
%g_{2}\left(\hat{\boldsymbol{f}}_{K}\right)
%\end{equation}
%
%\begin{equation}
%g_{T}\left(\hat{\boldsymbol{f}}_{K}\right)
%\end{equation}
%
%
%\begin{equation}
%g\left(\hat{f}_{1,2}\right)
%\end{equation}
%
%\begin{equation}
%g\left(\hat{f}_{2,2}\right)
%\end{equation}
%
%\begin{equation}
%g\left(\hat{f}_{J*,2}\right)
%\end{equation}
%
%
%\begin{equation}
%g\left(\hat{f}_{1,K}\right)
%\end{equation}
%
%\begin{equation}
%g\left(\hat{f}_{2,K}\right)
%\end{equation}
%
%\begin{equation}
%g\left(\hat{f}_{J*,K}\right)
%\end{equation}
%
%
%\begin{equation}
...
%
%\begin{equation}
%\hat{\sigma}_{t,K,1}^{16}
%\end{equation}
%
%
%\begin{equation}
%\sigma_{\hat{\sigma}_{t,K,2}^{16}}
%\end{equation}
%
%\begin{equation}
%\hat{\tau}_{t,K,1}^{16}
...
%
%\begin{equation}
%\hat{\sigma}_{c,K,2}^{238}
%\end{equation}
%
%\begin{equation}
%\sigma_{\hat{\sigma}_{c,2,2}^{238}}
%\end{equation}
%
%\begin{equation}
%\hat{\tau}_{c,K,2}^{238}
...
%
%\begin{equation}
%\hat{\sigma}_{f,K,1}^{235}
%\end{equation}
%
%\begin{equation}
%\sigma_{\hat{\sigma}_{f,K,1}^{235}}
%\end{equation}
%
%\begin{equation}
%\hat{\tau}_{f,K,1}^{235}

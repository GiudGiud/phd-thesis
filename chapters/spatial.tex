...
\begin{table}[H]
  \centering
  \caption[Standard deviations for pin-wise MGXS]{The standard deviation for pin-wise U-235 fission and U-238 capture \ac{MGXS}\footnotemark.}
  \small
...
\midrule
\multirow{2}{*}{\parbox{2.2cm}{BEAVRS Full Core}} & Max & -86.132 & -34.863 & 11.988 & 11.731 \\
& Mean & 40.218 & 11.539 & 1.650 & 1.709 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
\multirow{2}{*}{\parbox{2.2cm}{BEAVRS Quarter Core}} & Max & -85.536 & -34.835 & 6.507 & 8.296 \\
& Mean & 39.944 & 11.087 & 1.514 & 1.626 \\
\bottomrule
\end{tabular}
\end{table}

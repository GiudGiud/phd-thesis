...
\part{Introduction}
\include{chapters/introduction} % self-review, tbr
...
\include{chapters/beavrs-model} %self-review, tbr

\part{Implementation}
% anals
\include{chapters/modular-structure} % tbr
\include{chapters/track-laydown} % tbr
\include{chapters/otf-ray-tracing} % tbr
\include{chapters/linear-source} % tbr
\include{chapters/domain-decomposition} % tbr
\include{chapters/moc-convergence} % self-review, tbr

\part{Simulation Results}
% anals
\include{chapters/moc-sensitivity} % self-review, tbr
\include{chapters/full-core-results} % TODO, self-review, tbr

\part{Conclusions}
\include{chapters/conclusions} % TODO, self-review, tbr

...
\part{Introduction}
\include{chapters/introduction} %TODO
\include{chapters/literature-review} % TODO

\part{Background}
\include{chapters/transport-theory} % reviewed
\include{chapters/mgxs} % reviewed
\include{chapters/moc} % reviewed
\include{chapters/cmfd-acceleration} %reviewed
\include{chapters/beavrs-model} %TODO
%\include{chapters/workflow}

\part{Implementation}
% anals
\include{chapters/modular-structure} % tbr
\include{chapters/track-laydown} % tbr x kord
\include{chapters/otf-ray-tracing} % tbr
\include{chapters/linear-source} % TODO
\include{chapters/domain-decomposition} % tbr
\include{chapters/moc-convergence} % TODO: Review, 3D FC LS

\part{Simulation Results}
% anals
\include{chapters/moc-sensitivity} % TODO (incl. CMFD conv)
%\include{chapters/full-core-results} % TODO (incl. timing breakdown)

%\part{Conclusions}
%\include{chapters/conclusions} % TODO
%\include{chapters/appendices} % TODO
%\appendix

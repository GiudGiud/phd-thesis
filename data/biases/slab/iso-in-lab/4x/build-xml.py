...
fuel_mesh = opencg.LinearMesh('x', fuel_cell.min_x, fuel_cell.max_x, 4)
clad_mesh = opencg.LinearMesh('x', clad_cell.min_x, clad_cell.max_x, 4)
water_mesh = opencg.LinearMesh('x', water_cell.min_x, water_cell.max_x, 4)

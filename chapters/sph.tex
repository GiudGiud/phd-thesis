...
second paragraph: identify the metrics, outine what follows
-reduction in the eigenvalue bias
-reduction in the flux errors in energy and space
...
first paragraph: intro case study
-varying energy group structures
-varying \ac{FSR} discretizations
-refer back to Tables in Chap. 5
-iso-in-lab scattering

second paragraph: details on bias, synthesis
-slab
  -all biases consistently positive b/w 10 and 40 \ac{pcm} (with few exceptions)
  -magnitude of bias is reduced by nearly 10x
-pin
  -all biases consistently positive b/w 10 and 25 \ac{pcm} (with few exceptions)
  -smaller biases than for slab
  -generally biases were smaller with 4 or more groups
-bias minimized irregardless of energy group structure

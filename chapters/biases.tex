...
\begin{table}[h!]
  ...
  \midrule
  \multicolumn{1}{|c|}{\cellcolor{lightgray} {\bf \# Groups}} & \multicolumn{5}{c|}{\cellcolor{carolinablue} \bf Anisotropic without Transport Correction} \\
  \hhline{~|-----|}
1 & 70 & 71 & 72 & 72 & 71 \\
2 & 106 & -16 & -80 & -101 & -85 \\
4 & 112 & -2 & -63 & -90 & -87 \\
...
70 & 164 & -38 & -156 & -208 & {\cellcolor{darktangerine}} -221 \\
  \midrule
  \multicolumn{1}{c|}{\cellcolor{white}} & \multicolumn{5}{c|}{\cellcolor{lightgreen} \bf Anisotropic with Transport Correction} \\
  \midrule
1 & 87 & 88 & 88 & 88 & 87 \\
...
70 & 162 & -39 & -142 & -202 & {\cellcolor{darktangerine}} -198 \\
  \midrule
  \multicolumn{1}{c|}{\cellcolor{white}} & \multicolumn{5}{c|}{\cellcolor{lightgreen} \bf Anisotropic without Transport Correction} \\
  \midrule
1 & 85 & 90 & 103 & 92 & 98 \\
...
Fig.~\ref{fig:chap5-rel-err-space} highlights the spatial dependence of the error across the fuel for each energy range. These plots were generated for the benchmark models with a 16$\times$ \ac{FSR} discretization with \ac{MGXS} tallied on the \ac{FSR} mesh. The plots correspond to the case studies in Tabs.~\ref{table:chap5-slab-space} and~\ref{table:chap5-pin-space} with iso-in-lab scattering.
...
\begin{subfigure}{\textwidth}
  ...
  \caption{}
\end{subfigure}
\caption[Flux relative error by FSR]{The spatially-varying relative error of the OpenMOC scalar flux with respect to the reference OpenMC flux for a 1D slab (a) and 2D fuel pin (b) in energy Ranges A, B, and C. The results correspond to Tabs.~\ref{table:chap5-slab-space} and~\ref{table:chap5-pin-space}.}
...
\begin{figure}[h!]
  ...
  \caption{}
\caption[U-238 capture rates by FSR]{The normalized spatially-varying U-238 capture rates tallied by OpenMC for a 1D slab 2D fuel pin in Range A. The results correspond to Tabs.~\ref{table:chap5-slab-space} and~\ref{table:chap5-pin-space}.}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Reaction Rate Errors in the Resonance Region}
...
\begin{table}[H]
  \centering
  \caption[Reaction rate relative errors]{The volume-integrated U-238 capture and total absorption rate percent relative errors. The errors correspond to the results in Tabs.~\ref{table:chap5-slab-space} and \ref{table:chap5-pin-space}.}
  \small
...
\begin{itemize}
  ...
  \item The eigenvalues closely agreed for homogeneous infinite media. The eigenvalues exhibited a bias of -200 to -300 \ac{pcm} for heterogeneous 1D slab and 2D fuel pin benchmarks.

...
first paragraph: input generation
-see first paragraph in section 5 of OpenCG paper
-refer back to simulation triad figure - all in python
-rapidly convert an OpenMC or OpenMOC geometry into OpenCG and vice versa
-physics agnostic
  -OpenCG's geometry does not know how to model physics
  -OpenCG's geometry does not know how to discretize itself like OpenMOC
  -OpenCG's geometry does not know how to export itself to XML like OpenMC

second paragraph: geometry parameter optimization
-Python software model is advantageous to traditional ASCII input files
-see page 3/14 from OpenCG paper
-refer to region differentiation algorithm to come
-facilitates dynamic workflow between codes (e.g., OpenCG and OpenMOC w/ region diff)

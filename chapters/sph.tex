...
-inspected energy-dependent flux errors
...
-nearly flat error profile near zero for all groups
-refer back to Fig. 5.4 for dotted red/blue lines
-no discernible difference in error profiles b/w inner/outer FSRs
...
-SPH factors show nearly the expected behavior
  ...
  -factors >1 in groups with a negative error
  -factors <1 in groups with a positive error
  -factors deviate from 1 by roughly the same amount as the error 
    -an error 2.5\% in group 27 for a pin led to an SPH factor of 0.97, or roughly 3\% less than 1.0
    -likewise for other groups

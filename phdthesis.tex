...
\part{Background}
\include{chapters/transport-theory}
\include{chapters/mgxs}
\include{chapters/moc}
\include{chapters/cmfd-acceleration}
%\include{chapters/workflow}

\part{Implementation}
% anals
\include{chapters/modular-structure}
%%%%%% ^^^ Also code design / code development / practices %%%%%%%
\include{chapters/track-laydown}
\include{chapters/otf-ray-tracing}
%%%%%% ^^^ Make the chapter about ray tracing, not just OTF ray tracing %%%%%
%\include{chapters/linear-source}
%\include{chapters/cmfd-acceleration}
%\include{chapters/domain-decomposition}
%% Section on computational optimization???

%\part{3D Assembly Analysis}
% anals
%\include{chapters/xs-generation}
%\include{chapters/moc-convergence}
%\include{chapters/cmfd-optimization}

%\part{Computational Performance}
% jcp

%\part{Full Core Analysis}
%\include{chapters/beavrs-model}
%\include{chapters/full-core-results}

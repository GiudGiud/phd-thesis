...
\begin{itemize}
  \item The \textit{inferential \ac{MGXS}} (\textit{i}\ac{MGXS}) spatial homogenization scheme is introduced to use unsupervised clustering analysis of \ac{MC} tally data to predict which fuel pins experience similar spatial self-shielding effects.
  ...
  \begin{itemize}
    ...
    \item \textit{\textbf{Dimensionality reduction}} projects the features into a new vector space.
    \item \textit{\textbf{Predictor training}} applies a clustering algorithm to the feature vectors.
  ...
  \item The material configurations predicted by the \textit{i}\ac{MGXS} scheme for each of the six heterogeneous benchmarks was presented.

...
mention that the flux separability is used and hence the angle is dropped
...
\begin{table}[h!]
  ...
  {\bf Estimator} \\
  \midrule
  \multirow{2}{*}{\bf General} & \multirow{2}{*}{$\hat{\Sigma}_{x,k,g}$} & $\langle \Sigma_{x}, \psi \rangle_{k,g}$ & reaction $x$ & \parbox{2cm}{\centering \texttt{cell}/\texttt{material} \texttt{energy}} & \texttt{tracklength} \\
  \cline{3-6}

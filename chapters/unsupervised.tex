...
%This chapter begins by introducing a general latent variable model for \ac{MGXS} clustering which motivates \textit{i}\ac{MGXS} spatial homogenization in Sec.~\ref{sec:chap10-lsvm}. An overview of the \textit{i}\ac{MGXS} scheme is given in Sec.~\ref{sec:chap10-overview}, with in-depth presentations of each stage of tally data pre-processing, including feature extraction (Sec.~\ref{sec:chap10-feature-extract}) and selection (Sec.~\ref{sec:chap10-feature-select}), and dimensionality reduction (Sec.~\ref{sec:chap10-dimension-reduce}).
...
\begin{algorithmic}[1]
  ...
  \EndWhile 
  \State Compute cluster labels from MAP estimators\footnotemark \Comment{Eqn.~\ref{eqn:chap10-gmm-map}}
\end{algorithmic}
\end{algorithm}

\footnotetext{The maximum a posteriori (MAP) estimate is the mode of the \ac{GMM} distribution.}
...
\end{subfigure}
\caption[Clustered geometries for the 1.6\% enriched assembly]{Materials for the 1.6\% enriched fuel assembly with \textit{i}\ac{MGXS} spatial homogenization. The materials for 2, 4, and 8 clusters are illustrated in (a), (c) and (e) for pinch and in (b), (d) and (f) for litmus-only feature selection, respectively.}
...
\end{subfigure}
\caption[Clustered geometries for the 3.1\% enriched assembly]{Materials for the 3.1\% enriched fuel assembly with 20 \acp{BP} with \textit{i}\ac{MGXS} spatial homogenization. The materials for 2, 4, and 8 clusters are illustrated in (a), (c) and (e) for pinch and in (b), (d) and (f) for litmus-only feature selection, respectively.}
...
\end{subfigure}
\caption[Clustered geometries for the 2$\times$2 periodic colorset]{Materials for the 2$\times$2 periodic colorset with \textit{i}\ac{MGXS} spatial homogenization. The materials for 2, 4, and 8 clusters are illustrated in (a), (c) and (e) for pinch and in (b), (d) and (f) for litmus-only feature selection, respectively.}

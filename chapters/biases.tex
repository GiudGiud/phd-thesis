...
\begin{table}[h!]
  ...
  \multicolumn{1}{S[table-format=2.1]}{\cellcolor{lightgray} {\bf 0.001}} &
  \multicolumn{1}{S[table-format=2.1]}{\cellcolor{lightgray} {\bf 0.1}} & 
  {\cellcolor{lightgray} \bf 0.01} & 
  {\cellcolor{lightgray} \bf 0.001} \\
  \midrule
...
\vspace{0.5cm}
\begin{emphbox}
\textbf{The eigenvalues from OpenMC and OpenMOC agree to within 10 \ac{pcm} for a homogeneous infinite medium for all \ac{MOC} angular discretizations and energy groups structures.}
\end{emphbox}

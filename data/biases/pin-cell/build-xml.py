...
root_cell.add_surface(min_x, +1)
root_cell.add_surface(max_x, -1)
root_cell.add_surface(min_y, +1)
root_cell.add_surface(max_y, -1)
root_cell.add_surface(min_z, +1)
root_cell.add_surface(max_z, -1)
...
for scatter in scattering:
    ...
    for rings in num_rings:
        ...
        opencg_geometry = openmc.opencg_compatible.get_opencg_geometry(geometry)
        openmoc_geometry = openmoc.opencg_compatible.get_openmoc_geometry(opencg_geometry)
        ...
        opencg_geometry = openmoc.opencg_compatible.get_opencg_geometry(openmoc_geometry)

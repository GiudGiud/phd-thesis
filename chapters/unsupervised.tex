...
%      \State Add sample to subcluster with smallest post-merged radius
%      \State Update CF properties for the merged subcluster \Comment{Eqn.~\ref{eqn:chap10-birch-cf-additivity}}
	  \State Assign $\mathbb{N} \leftarrow \mathbb{N}_{a}$
%      \State Assign merged subcluster to $\mathbb{N}$
%      \State Merge sample with nearest subcluster
    \EndWhile
    ...
    \While{$\mathbb{N} \ne \mathbb{N}_{r}$ } 
      \If{$R_{\mathbb{N}} > T$}
        ...
        \EndIf
%        \State Split samples in merged subcluster into two subclusters

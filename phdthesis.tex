...
\part{Introduction}
\include{chapters/introduction} % tbr
...
\include{chapters/beavrs-model} % tbr
...
\include{chapters/moc-convergence} % tbr

\part{Simulation Results}
% anals
\include{chapters/moc-sensitivity} % tbr
\include{chapters/full-core-results} % tbr

\part{Conclusions}
\include{chapters/conclusions} % tbr
\include{chapters/appendices} % tbr
%\appendix
